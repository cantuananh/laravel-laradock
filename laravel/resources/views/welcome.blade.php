<head>
    ...
    <body>
    <div class="container">
    <div class="p-3 mb-2 bg-success text-white text-center"><h1>Tìm hiểu về docker</h1></div>
        <dl class="row">
            <hr>
            <dt class="col-sm-3">
            <h2>Docker là gì?</h2></dt>
            ...
            <dt class="col-sm-3"><h2>Docker images</h2></dt>
            <dd class="col-sm-9">
            ...
            <dt class="col-sm-3"><h2>Container là gì?</h2></dt>
            ...
            <dt class="col-sm-3 text-truncate"><h5>Dùng docker có gì tốt?</h5></dt>
            <dd class="col-sm-9">
            ...
            <dt class="col-sm-3"><h2>Docker khác vagrant ở đâu?</h2></dt>
            <dd class="col-sm-9">
